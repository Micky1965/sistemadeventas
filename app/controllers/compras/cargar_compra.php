...
$sql_compras = "SELECT *, co.precio_compra as precio_compra, pro.codigo as codigo, pro.nombre as nombre_producto, 
                pro.descripcion as descripcion, pro.stock as stock, pro.stock_minimo as stock_minimo, 
                pro.stock_maximo as stock_maximo,pro.precio_compra as precio_compra_producto,
                pro.precio_venta as precio_venta_producto, pro.fecha_ingreso as fecha_ingreso,
                cat.nombre_categoria as nombre_categoria, us.n_usuario as n_usuario_pro,
                prov.nombre_proveedor as nombre_proveedor, prov.telefono as telefono_proveedor,
                prov.email as email_proveedor, prov.direccion as direccion_proveedor, us.n_usuario as n_usuario 
...
foreach ($compras_datos as $compras_dato){
    ...
    $nombres_usuario = $compras_dato['n_usuario'];
