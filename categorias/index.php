                                    ...
                                    foreach ($categorias_datos as $categorias_dato) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-update<?php echo $id_categoria; ?>">
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <small style="color: red;display: none" id="lbl_update<?php echo $id_categoria; ?>">* Debe rellenar este campo</small>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer justify-content-between">
                                                                        ...
                                                                        <button type="button" class="btn btn-info" id="btn_update<?php echo $id_categoria; ?>">Actualizar</button>
                                                                    </div>
                                                                </div>
                                                                <!-- /.modal-content -->
                                                            </div>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <script>
                                                            $('#btn_delete<?php echo $id_categoria; ?>').click(function() {
                                                                ...
                                                                var url2 = "../app/controllers/categorias/delete_categoria.php";
                                                                $.get(url2, {
                                                                    id_categoria: id_categoria
                                                                }, function(datos) {
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <small style="color: red;display: none" id="lbl_create">* Debe rellenar este campo</small>
                        </div>
                    </div>
                </div>
            </div>
