...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">¿ Quiere Eliminar la Venta Nro <?= $nro_venta; ?> ?</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-danger">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <center>
                                    <button id="btn_eliminar_ven" class="btn btn-danger btn-lg">Eliminar</button>
                                    <div id="btn_eliminar_ven" ></div>
                                </center>
                            </div>
                            <script>
                                $('#btn_eliminar_ven').click(function () {
                                    ...
                                    function actualizar_stock () {
                                        ...
                                        for (i = 1; i <= n; i++) {
                                            ...
                                            var stock_calculado = (parseInt(stock_de_inventario) + parseInt(cantidad_carrito));
